void plot_th13(){
  ...
  //  Neutrino 2018
  double idx[5]={1,3,2,4,5};
  double value[5]={0.0856,0.071,0.0896,0.085,0.105,
  };
  double valueUncLow[5]={0.0029,0.011,0.0068,0.014,0.014
  };
  double valueUncHigh[5]={0.0029,0.011,0.0068,0.014,0.014
  };
  ...
  oscGraph->GetYaxis()->SetRangeUser(0,6.);
  ...
  TBox box;
  box.SetFillColor(17);
  box.DrawBox(dyb_update-dyb_update_low, 6.0, 
  ...
  TGraphAsymmErrors *oscGraph1 = new TGraphAsymmErrors(2, &value[2], &idx[2], &valueUncLow[2], &valueUncHigh[2], 0, 0);
  oscGraph1->SetTitle("");
  ...
  latex.DrawLatex(0.14,idx[2]-0.1,"RENO (nGd)");
  latex.DrawLatex(0.14,idx[3]-0.1,"RENO (nH)");

  TGraphAsymmErrors *oscGraph2 = new TGraphAsymmErrors(1, &value[4], &idx[4], &valueUncLow[4], &valueUncHigh[3], 0, 0);
  oscGraph2->SetTitle("");
  ...
  latex.DrawLatex(0.14,idx[4]-0.1,"Double Chooz ");
  latex.DrawLatex(0.14,idx[4]-0.5,"(nGd+nH)");
